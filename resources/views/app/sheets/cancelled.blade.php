                                ...
                                <div class="col-lg-12"> 
                                    ...
                                    <div class="panel ">
                                        ...
                                        <div class="panel-body"> 
                                          ...
                                          <div class="col-md-9">                    
                                          {!! Form::open(['method' => 'POST','class'=>'form-horizontal','enctype'=>'multipart/form-data', 'route' => 'getCancelledListPage']) !!}    
...
$( document ).ready(function() { 
    ...
    if(comingCreatedAt != ''){
        $('#reservedSheetsList').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('getCancelledListFilterData', $created_at) }}',
            columns: [
        ...
        $('#reservedSheetsList').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('getCancelledListData') }}',
            columns: [
                {data: 'id', name: 'id', visible:false }, 
                {data: 'order', name: 'order'}, 
                {data: 'created_at', name: 'created_at'}, 
