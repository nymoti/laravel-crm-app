                                    ...
                                    <div class="panel ">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">
                                                ...
                                                Liste des fiches réservation
                                            </h3> 
                                        </div>
                                        <div class="panel-body"> 
                                          <div class="row"  style="border: 2px solid #eee;border-radius: 5px;  padding-top: 16px;margin-left: 0px;    margin-right: 0px;">                    
                                          <div class="col-md-9">                    
                                          {!! Form::open(['method' => 'POST','class'=>'form-horizontal','enctype'=>'multipart/form-data', 'route' => 'getReservedSheetsFilterPage']) !!}    
...
$( document ).ready(function() { 
    ...
    if(comingCreatedAt != ''){
        $('#reservedSheetsList').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('getReservedSheetsFilterData', $created_at) }}',
            columns: [
        ...
        $('#reservedSheetsList').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('getReservedSheetsData') }}',
            columns: [
                {data: 'id', name: 'id', visible:false }, 
                {data: 'order', name: 'order'}, 
                {data: 'created_at', name: 'created_at'}, 
