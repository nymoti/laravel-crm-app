                        ...
                        <fieldset>
                            ...
                            <div data-row-span="5">
                                <div data-field-span="1">
                                    ...
                                    <input class="form-control" id="nbr_pax" name="nbr_pax" type="text" >
                                </div> 
                            </div>
                            <div data-row-span="4"> 
                                <div data-field-span="2">
                                    ...
                                    <div class="form-group  col-md-6"  style=" /*margin-left: 25%;*/">
                                      <div class='input-group date' id='date_arrived'>
                                          <input type='text' class="form-control" id="date_arrived"  name="date_arrived" placeholder="Arrivée" />
                                ...
                                <div data-field-span="2">
                                    ...
                                    <div class="form-group  col-md-6" style=" /*margin-left: 25%;*/">
                                      <div class='input-group date' id='date_departure'>
                                          <input type='text' class="form-control" id="date_departure"  name="date_departure" placeholder="Départ" />
                                          <span class="input-group-addon">
                                              <span class="glyphicon glyphicon-calendar"></span>
                                          </span>
                                      </div>
                            ...
                            <div data-row-span="4"> 
                                <div data-field-span="2">
                                    ...
                                    <div class="col-md-6  " style="margin-left: -12px;">
                                        <input class="form-control" id="da_flight_number" name="da_flight_number" type="text" >                                                                             
                                    </div>
                                </div> 
                                <div data-field-span="2">
                                    <label for="dd_flight_number" >Numéro de vol :</label>
                                    <div class="col-md-6" style="margin-left: -12px;">
                                        <input class="form-control " id="dd_flight_number" name="dd_flight_number" type="text" >                                     
                                    </div>
                                </div> 
                            </div>
                            <div data-row-span="3"> 
                                <div data-field-span="3">
                                    ...
                                    <input class="form-control" id="establishment" name="establishment" type="text" >
                                </div>  
                            </div> 
                        </fieldset>  
                            ...
                            <div data-row-span="8">
                                <div data-field-span="3">                                    
                                    <select id="select_supplements" name="supplements"> 
                                        ...
                                        <option value="LIT" title="LIT"   > LIT </option>  
                                        <option value="NUIT" title="NUIT"   > NUIT </option>  
                                        <option value="CHAMBRE" title="CHAMBRE"   > CHAMBRE </option>  
                                        <option value="SEMAINE" title="SEMAINE"   > SEMAINE </option>  
                                    </select>
                                </div> 
                            </div>
                            <div data-row-span="5"> 
                        ...
                        <fieldset>
                            ...
                            <div data-row-span="4" style="border-bottom: none;">
                                <div data-field-span="4">
                                    <textarea id="comments"  name="comments" class="resize_vertical" rows="4"> </textarea>
                                </div> 
                            </div> 
                        </fieldset>
                        <br>   
