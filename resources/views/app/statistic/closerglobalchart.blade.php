            ...
            <div class="panel ">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <i class="ti-pie-chart"></i> Statistiques  des closers
                    </h4> 
                </div>
                      ...
                      <div class="form-group col-md-8 col-md-offset-2">
                        <div class="row">
                          <div class="col-md-4" style="text-align: right;">
                              <label for="closer_id"  style="margin-top: 9px;text-align: right;padding: 0px">Liste des closers :</label>
                          </div>
                          <div class="col-md-6">
                            <select class="form-control  " id="closer_id" name="status">  
                                @foreach($list_closer as $closer)
                                <option value="{{$closer->id}}"  >{{$closer->last_name .' '. $closer->first_name}}</option> 
                                @endforeach
                            </select>                            
                          </div>
...
$(document).ready(function() { 
 ...
 format:'DD-MM-YYYY'
  ...
  $('#filter').click(function(e){
      ...
      // dateEndSend =  moment(dateEndSend).format("DD-MM-YYYY");
        ...
        $.ajax({
            ...
            success: function(dataCloser) {
              if(dataCloser.sheetPerCloser != 0){ 
                ...
                Command: toastr["error"]("Il y a pas de fiche !", "Statistiques")   
                 toastr.options = {
                  "closeButton": true,
                  "debug": false,
                  "newestOnTop": false,
