                  ...
                  <div class="panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="ti-layout-grid3"></i> Liste des utilisateurs désactivé
                            </h3>
                        ...
                        <div class="panel-body">
                            <div class="bs-example">
                                <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                                    <li class="active">
                                        <a href="#users_admin" data-toggle="tab">Les admins désactivé</a>
                                    </li>
                                    <li>
                                        <a href="#users_agent" data-toggle="tab">Les agents désactivé</a>
                                    </li>
                                    <li>
                                        <a href="#users_closer" data-toggle="tab">Les closers désactivé</a>
                                    </li> 
                                </ul>
